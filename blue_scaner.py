...
# Description:
# ------------
# blue_scanner.py is a Python script designed to scan for nearby Bluetooth devices
# and log their details. It uses the PyBluez library to perform Bluetooth device
# discovery. The script is useful for penetration testing, security audits, and
# general reconnaissance to understand the Bluetooth environment around you.
#
# Usage:
# ------
...
# during the scan to a file named 'bluetooth_scan.log'. This log file will be
...
def setup_logging():
    """
    Set up logging to a file named 'bluetooth_scan.log' to record information
...
def bluetooth_scan(duration):
    ...
    The details are printed to the console and logged to 'bluetooth_scan.log'.
